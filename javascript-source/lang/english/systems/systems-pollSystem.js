...
$.lang.register('pollsystem.draft.started', 'started a draft with $1 cards');
$.lang.register('pollsystem.draft.test', 'Pick voted card! Next poll starting in $1 seconds! Picking from $2 cards next with $3 seconds');
